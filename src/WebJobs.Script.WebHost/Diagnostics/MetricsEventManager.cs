...
namespace Microsoft.Azure.WebJobs.Script.WebHost.Diagnostics
{
    ...
    {        
        ...
        public MetricsEventManager(ISettingsManager settingsManager, IEventGenerator generator, int functionActivityFlushIntervalSeconds, int metricsFlushIntervalMS = DefaultFlushIntervalMS)
        {
            // we read these in the ctor (not static ctor) since it can change on the fly
            appName = GetNormalizedString(settingsManager.GetEnvironmentSetting(EnvironmentSettingNames.AzureWebsiteName)) ?? string.Empty;
