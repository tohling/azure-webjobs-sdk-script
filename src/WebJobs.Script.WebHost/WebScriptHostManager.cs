...
namespace Microsoft.Azure.WebJobs.Script.WebHost
{
    public class WebScriptHostManager : ScriptHostManager
    {
        ...
        public WebScriptHostManager(ScriptHostConfiguration config, ISecretManager secretManager, ISettingsManager settingsManager, WebHostSettings webHostSettings, IScriptHostFactory scriptHostFactory = null)
            : base(config, settingsManager, scriptHostFactory)
        {
            _config = config;
            _metricsLogger = new WebHostMetricsLogger(settingsManager);
        ...
        public WebScriptHostManager(ScriptHostConfiguration config, ISecretManager secretManager, ISettingsManager settingsManager, WebHostSettings webHostSettings)
        ...
        public static bool IsAzureEnvironment
        {
            get
            {
                return !string.IsNullOrEmpty(ScriptSettingsManager.Instance.GetEnvironmentSetting(EnvironmentSettingNames.AzureWebsiteInstanceId));
            }
        }
        ...
        public static bool InStandbyMode
        {
            get
            {
                ...
                if (ScriptSettingsManager.Instance.GetEnvironmentSetting(EnvironmentSettingNames.AzureWebsitePlaceholderMode) == "1")
                {
                    return true;
                }
