...
namespace Microsoft.Azure.WebJobs.Script.WebHost
{
    public sealed class WebHostResolver : IDisposable
    {
        ...
        public WebHostResolver(ISettingsManager settingsManager)
        {
        ...
        private static ScriptHostConfiguration GetScriptHostConfiguration(string scriptPath, string logPath)
        {
            ...
            string hostId = _settingsManager.GetEnvironmentSetting(EnvironmentSettingNames.AzureWebsiteName);
        ...
        private static ISecretManager GetSecretManager(ISettingsManager settingsManager, string secretsPath) => new SecretManager(settingsManager, secretsPath);
