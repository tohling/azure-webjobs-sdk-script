...
namespace Microsoft.Azure.WebJobs.Script.WebHost
{
    ...
    {
        internal static void Initialize(ISettingsManager settingsManager, ContainerBuilder builder, WebHostSettings settings)
        {
            builder.RegisterType<ScriptSettingsManager>().As<ISettingsManager>().SingleInstance();
