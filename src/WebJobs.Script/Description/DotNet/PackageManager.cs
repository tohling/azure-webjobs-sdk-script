...
namespace Microsoft.Azure.WebJobs.Script.Description
{
    ...
    internal sealed class PackageManager
    {
        ...
        public static string ResolveNuGetPath(string baseKuduPath = null)
        {
            ...
            string path = ScriptSettingsManager.Instance.GetEnvironmentSetting(NugetPathEnvironmentKey);
        ...
        internal static string GetNugetPackagesPath()
        {
            ...
            string home = ScriptSettingsManager.Instance.GetEnvironmentSetting(EnvironmentSettingNames.AzureWebsiteHomePath);
