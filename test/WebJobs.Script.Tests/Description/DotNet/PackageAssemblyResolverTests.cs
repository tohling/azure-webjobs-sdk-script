...
namespace Microsoft.Azure.WebJobs.Script.Tests
{
    public class PackageAssemblyResolverTests : IDisposable
    {
        ...
        public PackageAssemblyResolverTests()
        {
            ...
            _oldHomeEnv = _settingsManager.GetEnvironmentSetting(EnvironmentSettingNames.AzureWebsiteHomePath);
            ...
            _settingsManager.SetEnvironmentSetting(EnvironmentSettingNames.AzureWebsiteHomePath, _runPath);
        }
        ...
        public void Dispose()
        {
            ...
            _settingsManager.SetEnvironmentSetting(EnvironmentSettingNames.AzureWebsiteHomePath, _oldHomeEnv);
        }
