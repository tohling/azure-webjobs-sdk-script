...
namespace Microsoft.Azure.WebJobs.Script.Tests.Security
{
    ...
    {
        private ISettingsManager _settingsManager = ScriptSettingsManager.Instance;
        ...
        public void ReadKeyValue_CanRead_WrittenKey()
        {
            ...
            using (var variables = new TestScopedEnvironmentVariables(_settingsManager, AzureWebsiteLocalEncryptionKey, "0F75CA46E7EBDD39E4CA6B074D1F9A5972B849A55F91A248"))
            {
