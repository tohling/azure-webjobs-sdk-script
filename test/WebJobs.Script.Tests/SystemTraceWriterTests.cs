...
namespace Microsoft.Azure.WebJobs.Script.Tests
{
    public class SystemTraceWriterTests : IDisposable
    {
        ...
        public SystemTraceWriterTests()
        {
            ...
            _settingsManager.SetEnvironmentSetting(EnvironmentSettingNames.AzureWebsiteOwnerName, $"{_subscriptionId}+westuswebspace");

            _websiteName = "functionstest";
            _settingsManager.SetEnvironmentSetting(EnvironmentSettingNames.AzureWebsiteName, _websiteName);
        ...
        public void Dispose()
        {
            _settingsManager.SetEnvironmentSetting(EnvironmentSettingNames.AzureWebsiteOwnerName, null);
            _settingsManager.SetEnvironmentSetting(EnvironmentSettingNames.AzureWebsiteName, null);
        }
    }
}
