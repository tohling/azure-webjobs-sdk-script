...
namespace Microsoft.Azure.WebJobs.Script.Tests
{
    ...
    public class SamplesEndToEndTests : IClassFixture<SamplesEndToEndTests.TestFixture>
    {
        ...
        public async Task EventHubTrigger()
        {
            ...
            string connectionString = _settingsManager.GetEnvironmentSetting("AzureWebJobsEventHubSender");
            ...
            {
                string eventHubPath = _settingsManager.GetEnvironmentSetting("AzureWebJobsEventHubPath");
