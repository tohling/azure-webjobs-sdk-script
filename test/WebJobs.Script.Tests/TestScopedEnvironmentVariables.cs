...
namespace Microsoft.Azure.WebJobs.Script.Tests
{
    public class TestScopedEnvironmentVariables : IDisposable
    {
        ...
        public TestScopedEnvironmentVariables(ScriptSettingsManager settingsManager, string name, string value)
            : this(settingsManager, new Dictionary<string, string> { { name, value } })
        {
        }

        public TestScopedEnvironmentVariables(ScriptSettingsManager settingsManager, IDictionary<string, string> variables)
        {
